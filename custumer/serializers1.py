...
class EnfantS(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Enfant
        fields=['owner4','url','nom','prenom','annee_naissance','lieu_de_naissance','nationalite','numero_cni','sexes','ethnie','numero','parentf','ecolier','district','region','departement','sous_prefecture','commune','milieu_r','quartier']
...
class PostChargeSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Charge
        fields=['owner8','id','url','nom','prenom','annee_naissance','lieu_de_naissance','nationalite','numero_cni','sexes','ethnie','numero','niveau_etude','occupation','parentg']
